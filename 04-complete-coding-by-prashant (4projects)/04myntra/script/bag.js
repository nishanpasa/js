...
function is_bag_empty() {
  if (bag_item_arr.length === 0) {
    document.getElementById('bag_items_container').innerHTML = `
      ...
      ['original_price', 'discount_amount', 'delivery_charge', 'total_amount'].forEach(element => {
...
function remove_bag(item_id) {    
    ...
    //for total price 
    let total_amount_element = document.getElementById('total_amount');
    total_amount = total_amount_element.innerText;
    total_amount = Number(total_amount);

    console.log(total_amount);
    console.log(removed_item.original_price);
    console.log(current_discount_price_amount);
    ...
    total_amount = total_amount -  (removed_item.original_price - current_discount_price_amount);
